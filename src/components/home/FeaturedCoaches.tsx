    ...
    <section className="bg-background py-24 md:py-32 border-t border-border">
      <div className="container">
        ...
        <div className="flex items-end justify-between gap-6 mb-12 md:mb-16">
          <div>
            <span className="label-eyebrow text-gold">Featured coaches</span>
            <h2
          ...
          <Link
            to="/search"
            className="hidden md:inline-flex font-display uppercase tracking-[0.15em] text-sm text-foreground border-b border-copper pb-1 hover:text-gold transition-colors"
          >
            Browse all →
          </Link>
        </div>
          ...
          >
            ...
            <div className="absolute inset-x-0 bottom-0 p-8 md:p-10">
              <div className="flex items-center gap-3 mb-5">
                <span className="font-display uppercase tracking-[0.15em] text-[11px] text-foreground bg-background-secondary border border-border px-3 py-1">
                  {featured.sport}
                </span>
                {featured.verified && (
                  <span className="font-display uppercase tracking-[0.15em] text-[11px] text-gold border border-copper px-3 py-1">
                    ✓ Verified
                  </span>
                )}
              </div>

              <h3 className="font-display text-foreground text-3xl md:text-5xl tracking-tight">
                {featured.name}
              </h3>
              ...
              <div className="mt-6 flex items-end justify-between gap-4">
                ...
                <div className="font-display uppercase tracking-[0.12em] text-xs text-gold">
            ...
            {secondary.map(coach => (
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 p-6">
                  <span className="font-display uppercase tracking-[0.15em] text-[10px] text-foreground bg-background-secondary border border-border px-2.5 py-1">
                    {coach.sport}
                  </span>
                  <h4 className="mt-3 font-display text-foreground text-xl md:text-2xl tracking-tight">
                    {coach.name}
                  </h4>
